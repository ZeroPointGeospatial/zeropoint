(function () {
  ...
  /* Small visual fixes shared by the landing page and Projects page.
     Kept here so we don't disturb the existing Jekyll/CSS architecture. */
  const polish = document.createElement('style');
  polish.id = 'zp-small-polish';
  polish.textContent = `
    /* Menu: hidden unless explicitly opened. This prevents the mobile panel
       from appearing as a giant desktop tab if a stylesheet loads out of order. */
    ...
    @media (max-width:768px) {
      .mobile-menu { position:fixed; top:74px; left:0; right:0; z-index:9999; max-height:calc(100vh - 74px); overflow:auto; }
      .mobile-menu.open { display:flex !important; }
    }

    /* Request-service area: make the form feel like part of the site,
       not a browser-default embedded form. */
    ...
    #contact form {
      ...
      box-shadow:0 18px 45px rgba(11,13,12,.07);
    }
    ...
    #contact form .form-control {
      width:100%;
      min-height:46px;
      border:1px solid #c9cbc5 !important;
      border-radius:0 !important;
      background:#fff !important;
      color:#171a18 !important;
      padding:.72rem .8rem !important;
      font:400 .88rem 'Barlow',Arial,sans-serif !important;
    ...
    #contact form select:focus {
      ...
      border-color:#788653 !important;
      box-shadow:0 0 0 1px #788653 !important;
    }
    #contact form button,
    #contact form .btn,
    #contact form input[type='submit'] {
      ...
      color:#fff !important;
      font:600 .68rem 'Barlow',Arial,sans-serif !important;
    ...
    #contact form input[type='submit']:hover { background:#788653 !important; }
    #contact .success-msg,
    #contact #formSuccess {
      border-radius:0 !important;
      border-left:2px solid #788653 !important;
      background:#e7e9df !important;
      color:#30352f !important;
    }

    /* Projects page: turn the generic card grid into a restrained case-work index. */
    body:has(.project-grid) { background:#f1f0eb; }
    .page-hero {
      min-height:520px !important;
      padding:11rem 5.2% 5rem !important;
      display:flex;
    ...
    .page-hero::after {
      ...
      position:absolute;
      inset:0;
      background:linear-gradient(90deg,rgba(11,13,12,.96),rgba(11,13,12,.65) 55%,rgba(11,13,12,.25));
      pointer-events:none;
    }
    ...
    .project-card img {
      ...
      object-fit:cover;
      filter:grayscale(.12) saturate(.72);
    ...
    .coming-soon-panel .btn-primary { display:inline-flex; border-radius:0 !important; background:#0b0d0c !important; color:#fff !important; padding:.8rem 1rem; font-size:.65rem; letter-spacing:1px; text-transform:uppercase; }

    @media(max-width:768px) {
      #contact form { padding:1.35rem; }
      .page-hero { min-height:470px !important; padding:8rem 5% 3.5rem !important; }
      .page-hero h1 { font-size:clamp(3rem,14vw,5rem) !important; letter-spacing:-2px !important; }
      .project-grid { display:grid !important; grid-template-columns:1fr !important; }
      .project-card, .project-card:nth-child(1), .project-card:nth-child(2), .project-card:nth-child(3), .project-card:nth-child(4) { grid-column:1 !important; }
      .project-card img { height:240px !important; }
      .coming-soon-panel { padding:2rem 1.35rem !important; }
      .coming-soon-panel .checklist { grid-template-columns:1fr; }
    }
  `;
