...
date: 2026-05-19
excerpt: "Drones have changed what is possible in survey and mapping. But they have not replaced everything. Here is how to know which tool is right for your project."
---
...
- **Orthophotos** — georeferenced aerial images accurate to 3–5cm per pixel
- **Digital Surface Models (DSM)** — elevation data including vegetation and structures
- **Digital Terrain Models (DTM)** — bare earth elevation with vegetation filtered out
- **3D point clouds** — dense 3D representations of the terrain and features on it
- **Contour maps** — elevation lines at any specified interval
...
- **Boundary demarcation** — placing beacons at legally correct coordinates
- **Control networks** — establishing the precise reference points that everything else ties to
- **Feature survey** — accurately locating specific infrastructure (manholes, utility poles, building corners)
- **Setting out** — placing physical pegs or marks at design coordinates for construction
- **Cross-section survey** — collecting ground profile data along defined lines for engineering design
...
- What accuracy specification will this data meet?
- How will the data be verified — what quality control process is in place?
- What coordinate system and datum will the data be referenced to?
- What deliverable formats will be provided?
- Will the work be conducted by a licensed surveyor registered with the Survey of Kenya?

The answers will tell you quickly whether you are dealing with a competent firm or not.

---

*ZeroPoint Geospatial operates both drone mapping and RTK survey services across Kenya. We will always recommend the method that is right for your project, not the one that is easiest for us. [Request a quote](/contact).*
