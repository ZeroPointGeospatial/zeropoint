...
date: 2026-05-26
excerpt: "African cities are growing faster than any region on earth. GIS is quietly becoming the most powerful tool planners have to keep up."
---
...
## What GIS Actually Does for a City
...
- Which informal settlements are within 500 metres of a flood-prone river?
- Where are the gaps in water pipe coverage relative to population density?
- If a new road is built here, which schools become accessible within 30 minutes by foot?
- Where is land use change happening fastest, and is it outpacing permits?
...
## Real Applications Across the Continent

### Nairobi: Informal Settlement Upgrading
...
- High-resolution drone imagery converted into georeferenced base maps
- Community-led boundary demarcation using GPS and mobile data collection apps
- Integration of infrastructure data (roads, drainage, water points) into a central GIS database
...
### Kigali: Land Administration Reform
...
- **Incomplete** — large areas have never been formally surveyed
- **Inconsistent** — different agencies collect data in different formats with no interoperability
- **Outdated** — cities are changing faster than datasets are updated
- **Inaccessible** — data that exists is often siloed in individual departments or held by private firms
...
## What Good Urban GIS Looks Like

The best urban GIS implementations share common characteristics:

1. **Centralised data management** — a single authoritative database, not a dozen spreadsheets
2. **Field-to-database workflows** — survey data collected in the field flows directly into the GIS with minimal manual re-entry
3. **Regular update cycles** — data is treated as a living asset, not a one-time project output
4. **Multi-agency access** — roads, utilities, planning, and land departments all working from the same spatial data
5. **Public-facing portals** — citizens can see what is planned for their area
...
- A base map of the urban area from existing satellite or drone imagery
- GPS survey of key infrastructure assets (roads, water points, drainage)
- A simple GIS database in QGIS (free and open source)
- Staff trained in basic data entry and spatial query
...
*ZeroPoint Geospatial provides RTK survey, drone mapping, and GIS data services to county governments, developers, and NGOs across Kenya. [Get in touch](/contact) to discuss your project.*
